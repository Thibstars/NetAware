...
/**
 * Event to be dispatched when a scan job is started.
 *
 * @author Thibault Helsmoortel
 */
public class ScanJobStartedEvent<S extends Scanner<?>> extends TimeStampedEvent {

    public ScanJobStartedEvent(S source) {
        super(source);
    }
